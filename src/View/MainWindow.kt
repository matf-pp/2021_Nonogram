...
class MainWindow : Application() {
    ...
    override fun start(stage: Stage) {
        ...
        hItem2.onAction = EventHandler { e: ActionEvent? ->
            ...
            info.contentText = "U meniju fajlovi se nalaze tri akcije. Prva akcija je učitavanje nonograma iz .txt fajla. Prva linija fajla treba da sadrži brojeve n i m, koji predstavljaju dimenzije nonograma, potom sledi n linija, od kojih svaka sadrži broj l i potom l brojeva, gde l predstavlja broj ograničenja u odgovarajućoj vrsti, a zatim slede ta ograničenja. Nakon toga sledi m linija, istog formata, koje predstavljaju ograničenja za kolone. Druga akcija, sačuvaj sliku u bazi, predstavlja operaciju čuvanja slike u bazu za buduće slučajno generianje nonogram puzle na osnovu nje. Treća akcija, je akcija generisanja slučajne slike iz baze u skladu sa parametrima zadatim u meniju generisanje slika."
            info.showAndWait()
        }
